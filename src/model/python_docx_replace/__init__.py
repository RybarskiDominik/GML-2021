...
from model.python_docx_replace.exceptions import EndTagNotFound, InitialTagNotFound, TableIndexNotFound
from model.python_docx_replace.paragraph import Paragraph

__all__ = ["docx_replace", "docx_blocks", "docx_remove_table"]


def docx_replace(doc, replacements: dict) -> None:
    """
